<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 class="font-semibold text-xl text-slate-900 leading-tight">Gestion des tâches</h2>
                <p class="mt-1 text-sm text-slate-500">Assigner, suivre et compléter les tâches des activités.</p>
            </div>
